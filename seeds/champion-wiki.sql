...
- **제외 범위:** 아이템 순서와 승률처럼 패치에 민감한 값은 다루지 않는다.', 1, '16.17.1', 'guarded', '2026-09-11T05:03:01.000Z', '2026-09-11T05:03:01.000Z', 'user-system'
...
SELECT 'edit-ai-champion-katarina-20260911', id, NULL, 0, general, 'AI 작성: 실전 라인전 초안', 'accepted', 'user-system', '2026-09-11T05:03:01.000Z', 'admin', 1 FROM wiki_docs
...
SELECT 'doc-ai-champion-katarina-20260911', NULL, '라인전', '라인전' FROM wiki_docs WHERE id = 'doc-ai-champion-katarina-20260911';
INSERT OR IGNORE INTO wiki_links (source_doc, source_key, target_key, target_title)
SELECT 'doc-ai-champion-katarina-20260911', NULL, '로밍', '로밍' FROM wiki_docs WHERE id = 'doc-ai-champion-katarina-20260911';
...
- **운용 판단:** 현재 스킬 구조에서 도출한 상황별 판단이며 직접 플레이한 경험담이 아니다.
- **제외 범위:** 특정 아이템으로 궁극기가 반드시 막힌다는 식의 패치 의존 단정은 피했다.', 1, '16.17.1', 'guarded', '2026-09-11T05:03:01.000Z', '2026-09-11T05:03:01.000Z', 'user-system'
WHERE NOT EXISTS (SELECT 1 FROM wiki_docs WHERE id = 'doc-ai-champion-zed-20260911' OR (kind = 'article' AND title_key = '제드'));
INSERT INTO wiki_edits (id, doc_id, me_slug, base_revision, body, summary, status, author, created_at, accepted_via, revision)
SELECT 'edit-ai-champion-zed-20260911', id, NULL, 0, general, 'AI 작성: 실전 라인전 초안', 'accepted', 'user-system', '2026-09-11T05:03:01.000Z', 'admin', 1 FROM wiki_docs
...
INSERT OR IGNORE INTO wiki_links (source_doc, source_key, target_key, target_title)
SELECT 'doc-ai-champion-zed-20260911', NULL, '라인전', '라인전' FROM wiki_docs WHERE id = 'doc-ai-champion-zed-20260911';
INSERT OR IGNORE INTO wiki_links (source_doc, source_key, target_key, target_title)
SELECT 'doc-ai-champion-zed-20260911', NULL, '한타', '한타' FROM wiki_docs WHERE id = 'doc-ai-champion-zed-20260911';
...
- **스킬 구조:** Riot 공식 챔피언 소개와 Data Dragon 16.17.1 한국어 자료를 확인했다.[* [Riot 공식 아칼리 소개](https://www.leagueoflegends.com/ko-kr/champions/akali/)]
- **운용 판단:** 현재 스킬 구조에서 도출한 상황별 판단이며 직접 플레이한 경험담이 아니다.
- **확인 기준:** 정확한 기력 소모량과 재사용 대기시간은 현재 게임 툴팁을 우선한다.', 1, '16.17.1', 'guarded', '2026-09-11T05:03:01.000Z', '2026-09-11T05:03:01.000Z', 'user-system'
WHERE NOT EXISTS (SELECT 1 FROM wiki_docs WHERE id = 'doc-ai-champion-akali-20260911' OR (kind = 'article' AND title_key = '아칼리'));
INSERT INTO wiki_edits (id, doc_id, me_slug, base_revision, body, summary, status, author, created_at, accepted_via, revision)
SELECT 'edit-ai-champion-akali-20260911', id, NULL, 0, general, 'AI 작성: 실전 라인전 초안', 'accepted', 'user-system', '2026-09-11T05:03:01.000Z', 'admin', 1 FROM wiki_docs
...
- **스킬 구조:** Riot 공식 챔피언 소개와 Data Dragon 16.17.1 한국어 자료를 확인했다.[* [Riot 공식 아칼리 소개](https://www.leagueoflegends.com/ko-kr/champions/akali/)]
- **운용 판단:** 현재 스킬 구조에서 도출한 상황별 판단이며 직접 플레이한 경험담이 아니다.
- **확인 기준:** 정확한 기력 소모량과 재사용 대기시간은 현재 게임 툴팁을 우선한다.'
AND NOT EXISTS (SELECT 1 FROM wiki_edits WHERE id = 'edit-ai-champion-akali-20260911');
INSERT OR IGNORE INTO wiki_links (source_doc, source_key, target_key, target_title)
SELECT 'doc-ai-champion-akali-20260911', NULL, '라인전', '라인전' FROM wiki_docs WHERE id = 'doc-ai-champion-akali-20260911';
INSERT OR IGNORE INTO wiki_links (source_doc, source_key, target_key, target_title)
SELECT 'doc-ai-champion-akali-20260911', NULL, '한타', '한타' FROM wiki_docs WHERE id = 'doc-ai-champion-akali-20260911';
...
- **운용 판단:** 현재 스킬 구조에서 도출한 상황별 판단이며 직접 플레이한 경험담이 아니다.
- **제외 범위:** 궁극기 피해 수치나 고정 콤보의 처치 체력은 제시하지 않는다.', 1, '16.17.1', 'guarded', '2026-09-11T05:03:01.000Z', '2026-09-11T05:03:01.000Z', 'user-system'
WHERE NOT EXISTS (SELECT 1 FROM wiki_docs WHERE id = 'doc-ai-champion-fizz-20260911' OR (kind = 'article' AND title_key = '피즈'));
INSERT INTO wiki_edits (id, doc_id, me_slug, base_revision, body, summary, status, author, created_at, accepted_via, revision)
SELECT 'edit-ai-champion-fizz-20260911', id, NULL, 0, general, 'AI 작성: 실전 라인전 초안', 'accepted', 'user-system', '2026-09-11T05:03:01.000Z', 'admin', 1 FROM wiki_docs
...
INSERT OR IGNORE INTO wiki_links (source_doc, source_key, target_key, target_title)
SELECT 'doc-ai-champion-fizz-20260911', NULL, '라인전', '라인전' FROM wiki_docs WHERE id = 'doc-ai-champion-fizz-20260911';
INSERT OR IGNORE INTO wiki_links (source_doc, source_key, target_key, target_title)
SELECT 'doc-ai-champion-fizz-20260911', NULL, '한타', '한타' FROM wiki_docs WHERE id = 'doc-ai-champion-fizz-20260911';
...
- **운용 판단:** 현재 스킬 구조에서 도출한 상황별 판단이며 직접 플레이한 경험담이 아니다.
- **제외 범위:** 아이템과 룬은 상대 조합과 패치에 따라 달라져 고정 추천으로 넣지 않았다.', 1, '16.17.1', 'guarded', '2026-09-11T05:03:01.000Z', '2026-09-11T05:03:01.000Z', 'user-system'
WHERE NOT EXISTS (SELECT 1 FROM wiki_docs WHERE id = 'doc-ai-champion-leblanc-20260911' OR (kind = 'article' AND title_key = '르블랑'));
INSERT INTO wiki_edits (id, doc_id, me_slug, base_revision, body, summary, status, author, created_at, accepted_via, revision)
SELECT 'edit-ai-champion-leblanc-20260911', id, NULL, 0, general, 'AI 작성: 실전 라인전 초안', 'accepted', 'user-system', '2026-09-11T05:03:01.000Z', 'admin', 1 FROM wiki_docs
...
INSERT OR IGNORE INTO wiki_links (source_doc, source_key, target_key, target_title)
SELECT 'doc-ai-champion-leblanc-20260911', NULL, '라인전', '라인전' FROM wiki_docs WHERE id = 'doc-ai-champion-leblanc-20260911';
INSERT OR IGNORE INTO wiki_links (source_doc, source_key, target_key, target_title)
SELECT 'doc-ai-champion-leblanc-20260911', NULL, '한타', '한타' FROM wiki_docs WHERE id = 'doc-ai-champion-leblanc-20260911';
